      ...
      <div className="h-[70%]  flex w-full max-w-6xl rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="w-1/2 h-full bg-white px-12 py-20 flex flex-col justify-center">
          ...
          <div className='mb-5 px-7'>
            <h3 className="text-xl font-semibold mb-2 text-gray-500">Create a New Password</h3>
            <p className='text-sm text-gray-400'>Set a strong password to secure your admin account.</p>
          </div>
          ...
          <div className="space-y-4 w-full max-w-md mx-auto">
            ...
            {/* Button for Submit */}
            <button className='w-full rounded-xl h-8' style={{backgroundColor : "#6B6DFE", color : 'white' }} onClick={()=>handleLogin()}>Submit</button>
